...
gulp.task('connect-quick', function() {
    ...
    var app = connect()
        ...
        .use(require('connect-modrewrite')(['^/prepare-and-get-ready/(.*)$ http://em-public.ci.devcop.em.vic.gov.au/prepare-and-get-ready/$1 [P]']))
        .use(require('connect-modrewrite')(['^/relief-and-recovery/(.*)$ http://em-public.ci.devcop.em.vic.gov.au/relief-and-recovery/$1 [P]']))
