...
var app = app||{};
app.data = app.data||{};
app.data.copRelief = app.data.copRelief || {};

(function() {

    this.filters = [{
        name: 'Major Recovery',
        rules: [['copRelief:public-info']]
    }];
    ...
    this.classifyFeature = function(feature) {
        ...
        if (feature.properties.feedType === 'public-info') {
            ...
            category = util.rules.execute(app.data.filters,['copRelief:'+feature.properties.feedType]);
        } else {
    ...
    this.dataFilter = function(f) {
        return (f.properties.feedType === 'public-info') &&
            (f.properties.category1 === 'Recovery');
    };
