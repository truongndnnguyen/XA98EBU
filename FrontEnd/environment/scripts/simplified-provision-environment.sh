...
CLI_OPTS="--disable-rollback --timeout-in-minutes ${STACK_TIMEOUT_MINS}"
...
$AWS_BIN cloudformation create-stack --stack-name "${STACK_NAME}" --template-body "${TEMPLATE_BODY}" $CLI_OPTS --parameters \
