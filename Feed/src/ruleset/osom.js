...
exports.classify = function(feature) {
    ...
    var iconClass = feature.properties.cssClass || 'other',
        ...
        moreInformation = feature.properties.url ? true : false,
    ...
    categories = rules.executeMultiMatch(this.filters,
    ...
    var categoryNames = categories.map(function(f){
        return f.name;
    });

    // default styles from the style rules
    var match = rules.execute(this.styles,
    ...
    match = rules.execute(this.priorities,
        [feature.properties.feedType, feature.properties.category1, feature.properties.category2, feature.properties.status]);
    if( match !== null ) {
        riskRating += match.priority || 0;
    }
    ...
    if (feature.properties.feedType === 'public-info') {
        ...
        title = feature.properties.category1 + ' - ' + feature.properties.category2;
    ...
    return {
        ...
        categories: categoryNames.length?categoryNames:['Other'],
        style: style,
        iconClass: iconClass,
...
exports.styles = [
        ...
        },
        {
            ...
            rules: [
                ...
                ['warning','*','Very Dangerous Thunderstorm']
            ]
        },
        {
            iconClass: 'watchact',
